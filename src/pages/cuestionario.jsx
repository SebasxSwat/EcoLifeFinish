...
const CuestionarioHuellaCarbono = () => {
  ...
  const handleSubmit = async () => {
    ...
    const consumoElectrico = (respuestas.consumoElectrico / 100) * 3000 * 0.001;
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:8080/carbon-footprint/save",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        throw new Error(
          errorData.message || "Error al guardar la huella de carbono"
        );
      }
    } catch (error) {
      ...
      <div className="container mx-auto p-4 bg-gradient-to-br from-green-50 to-blue-50 min-h-screen flex items-center justify-center">
        <Card className="w-full max-w-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Responde a estas preguntas para calcular tu impacto ambiental.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <motion.div
            ...
            >
              ...
              <div className="space-y-4">
                <Slider
                  ...
                  onValueChange={value =>
                    handleSliderChange(value, questions[currentQuestion].field)
                  }
                  max={100}
                  step={1}
                />
      ...
      <Dialog open={showExitDialog} onOpenChange={setShowExitDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Si sales ahora, perderás todo el progreso en el cuestionario.
      ...
      <Dialog open={showWarningModal} onOpenChange={setShowWarningModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Por favor, no salgas del cuestionario hasta que lo hayas
              completado. Si sales, perderás todo tu progreso y tendrás que
              empezar de nuevo.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
