...
// Datos de noticias simuladas en español
const datosNoticias = [
  {
    id: 1,
...
export function NoticiasEcologicas() {
  ...
  useEffect(() => {
    obtenerNoticias()
    // Configurar intervalo para obtener noticias cada 5 minutos
  ...
  return (
    (<div
      ...
      <Card className="w-full max-w-4xl mx-auto shadow-lg">
        <CardHeader>
          <CardTitle
            className="text-3xl font-bold text-green-800 flex items-center justify-between">
        ...
        <CardContent>
          {cargando ? (
            <div className="text-center py-8">
              <div
                className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-700 mx-auto"></div>
